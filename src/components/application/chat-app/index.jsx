                                  ...
                                  <li key={index} className='clearfix'>
                                    <div className={`message my-message ${item.sender !== currentUser.id ? '' : 'float-end'}`}>
                                      <Media
                                        ...
                                        className={`rounded-circle ${item.sender !== currentUser.id ? 'float-start' : 'float-end'} chat-user-img img-30`}
                                        alt=''
                                      />
                          ...
                          <Row>
                            ...
                            <Col xl='12' className='d-flex'>
                              ...
                              <InputGroup className='text-box'>
                                ...
                                />
                                <Button className='input-group-text' color='primary' onClick={() => handleMessagePress('send')}>
                                  {Send}
                                </Button>
                              </InputGroup>
                            </Col>
                      ...
                      <TabContent activeTab={activeTab}>
                        ...
                        <TabPane tabId='2'>
                          ...
                          <div className='status'>
                            ...
                            <p>
                              {ChataApp_p2}
                              <i className='icofont icofont-emo-rolling-eyes font-success f-20 m-l-5'></i>
                            </p>
                          </div>
                        </TabPane>
                        <TabPane tabId='3'>
