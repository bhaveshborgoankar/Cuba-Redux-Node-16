                      ...
                      <div className='media'>
                        ...
                        <div className='media-body'>
                          <Link to={`${process.env.PUBLIC_URL}/app/users/profile/${layout}`}>
                            <h6 className='f-w-500'>{MARKJENCO}</h6>
                          </Link>
                          <p>{MARKJENCOEMAIL}</p>
                        </div>
                      </div>
                          ...
                          <Modal className='modal-bookmark' isOpen={categoryModal} toggle={categoryToggle}>
                            ...
                            <ModalBody>
                              <Form className='form-bookmark'>
                                ...
                                <Button color='secondary mt-2' onClick={categoryToggle}>
                                  {Save}
                                </Button>
                                <Button color='primary' className='ms-1 mt-2' onClick={categoryToggle}>
                                  {Cancel}
                                </Button>
                              </Form>
                            </ModalBody>
                                      ...
                                      <Row>
                                        ...
                                        <FormGroup className='col-md-12'>
                                          ...
                                          <input
                                            ...
                                            {...register('age', { required: true, pattern: /\d+/, min: 18, max: 70 })}
                                          />
                                          <span style={{ color: 'red' }}>{errors.age && 'Please enter age between 18 to 70 year.'}</span>
                                        </FormGroup>
                                        <FormGroup className='col-md-12'>
                                          ...
                                          <input
                                            ...
                                            {...register('mobile', { pattern: /\d+/, minlength: 0, maxlength: 9 })}
                                          />
                                          <span style={{ color: 'red' }}>{errors.mobile && 'Please enter number max 9 digit'}</span>
                                        </FormGroup>
                                      </Row>
                                      <Button color='secondary' className='update-contact me-1 mt-2'>
                                        {Save}
                                      </Button>
                                      <Button color='primary mt-2' onClick={() => setEditing(false)}>
                                        {Cancel}
                                      </Button>
                                    </Form>
                                  </div>
                                  ...
                                  <TabPane tabId='1'>
                                    <div className='profile-mail'>
                                      ...
                                      <div className='email-general'>
                                        <h6>{General}</h6>
                                        <p>
                                          {EmailAddress}: <span className='font-primary email_add_5'>{MARKJENCOEMAIL}</span>
                                        </p>
                        ...
                        <div className='history-details'>
                          ...
                          <div className='media'>
                            ...
                            <div className='media-body mt-0'>
                              ...
                              <span className='f-12'>{'Feb 10, 2022 4:00'}</span>
                            </div>
                          </div>
                        </div>
                      </div>
                      {selectedUser ? (
                        <Modal className='modal-bookmark' isOpen={printmodal} toggle={printModalToggle}>
                          ...
                          <ModalBody className='list-persons'>
                            ...
                            <Button color='primary mt-2' onClick={printModalToggle}>
                              {Cancel}
                            </Button>
                          </ModalBody>
                        </Modal>
