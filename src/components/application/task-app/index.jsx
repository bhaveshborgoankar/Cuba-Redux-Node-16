                  ...
                  <CardBody>
                    <div className='email-app-sidebar left-bookmark'>
                      ...
                      <Nav className='main-menu' role='tablist'>
                          ...
                          <Modal className='modal-bookmark' isOpen={addModal} toggle={addToggle} size='lg'>
                            ...
                            <ModalBody>
                              <Form className='form-bookmark needs-validation' onSubmit={handleSubmit(Addtask)}>
                                ...
                                <Button color='primary mt-2' onClick={addToggle}>
                                  {Cancel}
                                </Button>
                              </Form>
                            </ModalBody>
                        ...
                        <NavItem>
                          <a href='#javaScript' className={activeTab === '7' ? 'active' : ''} onClick={() => setActiveTab('7')}>
                            <span className='title'>
                              {' '}
                              {AssignedToMe} ({newtaskdata.length})
                            </span>
                          </a>
                        </NavItem>
                        <NavItem>
                        ...
                        <NavItem>
                          <a href='#javaScript' className={activeTab === '11' ? 'show' : ''} onClick={() => setActiveTab('11')}>
                            <span className='title'> {Business}</span>
                          </a>
                        </NavItem>
                        <NavItem>
                          <a href='#javaScript' className={activeTab === '12' ? 'show' : ''} onClick={() => setActiveTab('12')}>
                  ...
                  <div className='ps-0'>
                    <TabContent activeTab={activeTab}>
                      ...
                      <TabPane tabId='2'>
                        <Card className='mb-0'>
                          <CardHeader className='d-flex'>
                            <h6 className='mb-0'>{TodayTasks}</h6>
                            <a href='#javascript'>
                              <Printer className='me-2' />
                              {Print}
                            </a>
                      ...
                      <TabPane tabId='3'>
                        <Card className='mb-0'>
                          <CardHeader className='d-flex'>
                            <h6 className='mb-0'>{DelayedTasks}</h6>
                            <a href='#javascript'>
                              <Printer className='me-2' />
                              {Print}
                            </a>
                      ...
                      <TabPane tabId='4'>
                        <Card className='mb-0'>
                          <CardHeader className='d-flex'>
                            <h6 className='mb-0'>{UpcomingTasks}</h6>
                            <a href='#javascript'>
                              <Printer className='me-2' />
                              {Print}
                            </a>
                      ...
                      <TabPane tabId='5'>
                        <Card className='mb-0'>
                          <CardHeader className='d-flex'>
                            <h6 className='mb-0'>{ThisWeekTask}</h6>
                            <a href='#javascript'>
                              <Printer className='me-2' />
                              {Print}
                            </a>
                      ...
                      <TabPane tabId='6'>
                        <Card className='mb-0'>
                          <CardHeader className='d-flex'>
                            <h6 className='mb-0'>{ThisMonthTasks}</h6>
                            <a href='#javascript'>
                              <Printer className='me-2' />
                              {Print}
                            </a>
                                      ...
                                      newtaskdata.map((taskdata, index) => {
                                        return (
                                          <tr key={index}>
                                            ...
                                            <td>
                                              <a href='#javascript' onClick={() => RemoveTask(taskdata.id)}>
                                                <Trash2 />
                                              </a>
                                            </td>
                                          </tr>
