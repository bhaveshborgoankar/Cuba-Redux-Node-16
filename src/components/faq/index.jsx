              ...
              <Row className='default-according style-1 faq-accordion' id='accordionoc'>
                <div className='col-xl-8 xl-60 col-lg-6 col-md-7'>
                  ...
                  <Card>
                    <CardHeader>
                      <h5 className='mb-0'>
                        <button className='btn btn-link collapsed ps-0' onClick={() => setIsCollaps4(!isCollaps4)} data-toggle='collapse' data-target='#collapseicon5' aria-expanded={isCollaps4}>
                          <HelpCircle /> {'WordPress Site Maintenance ?'}
                        </button>
                      </h5>
                    </CardHeader>
                  ...
                  <Card>
                    <CardHeader>
                      <h5 className='mb-0'>
                        <button className='btn btn-link collapsed ps-0' onClick={() => setIsCollaps7(!isCollaps7)} data-toggle='collapse' data-target='#collapseicon9' aria-expanded={isCollaps7}>
                          <HelpCircle /> {'WordPress Site Maintenance ?'}
                        </button>
                      </h5>
                    </CardHeader>
                  ...
                  <Card>
                    <CardHeader>
                      <h5 className='mb-0'>
                        <button className='btn btn-link collapsed ps-0' onClick={() => setIsCollaps11(!isCollaps11)} data-toggle='collapse' data-target='#collapseicon13' aria-expanded={isCollaps11}>
                          <HelpCircle />
                          {'Integrating WordPress with Your Website ?'}
                        </button>
                      </h5>
                          ...
                          <div className='navigation-option'>
                            <ul>
                              ...
                              <li>
                                ...
                                <span className='badge bg-primary rounded-pill pull-right'>{'42'}</span>
                              </li>
                              <li>
                                <a href='#javascript'>
                                  <Youtube />
                                ...
                                <span className='badge bg-primary rounded-pill pull-right'>{'648'}</span>
                              </li>
                              <li>
                                <a href='#javascript'>
                                  <MessageCircle />
                        ...
                        <div className='card-body faq-body'>
                          <div className='media updates-faq-main'>
                            ...
                            <div className='media-body updates-bottom-time'>
                              <p>
                                <a href='#javascript'>{DavidLinner} </a>
                          ...
                          <div className='media updates-faq-main'>
                            ...
                            <div className='media-body updates-bottom-time'>
                              <p>
                                {UserChristopher} <a href='#javascript'>{'Wallace'}</a> {'is on hold and awaiting for staff reply'}
                              </p>
                              <p>{'45 minutes ago'}</p>
                            </div>
                          </div>
                          <div className='media updates-faq-main'>
                            ...
                            <div className='media-body updates-bottom-time'>
                              <p>
                                {'Ticket #43683 has been closed by'} <a href='#javascript'>{VictoriaWilson}</a>
                              </p>
                              <p>{'Dec 7, 11:48'}</p>
                            </div>
                          </div>
