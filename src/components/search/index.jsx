                      ...
                      <Row>
                        <Col xl='8' className='box-col-12'>
                          ...
                          <div className='info-block'>
                            <a href='#javascript'>{'https://themeforest.net/user/pixelstrap/portfolio/'}</a>
                          ...
                          <div className='info-block'>
                            <a href='#javascript'>{'PixelStrap - Portfolio | ThemeForestthemeforest.net › user › '}</a>
                            <h6>{'PixelStrap - Portfolio | ThemeForest'}</h6>
                        ...
                        <Col xl='4' className='box-col-12 mt-4'>
                          <div className='card o-hidden'>
                            <div className='blog-box blog-shadow'>
                              <img className='img-fluid' src={require('../../assets/images/blog/blog.jpg')} alt='' />
                          ...
                          <figure className='col-xl-3 col-sm-6' itemProp='associatedMedia' itemScope=''>
                            <a href='#javascript' itemProp='contentUrl' data-size='1600x950'>
                              <Media
                                ...
                                alt='Gallery'
                                className='img-thumbnail'
                                onClick={() => setPhotoIndex({ ...photoIndex, index: 2, isOpen: true })}
                              />
                              <div className='caption'>
                                <h4>{PortfolioTitle}</h4>
                                <p>{"is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy."}</p>
                          ...
                          <figure className='col-xl-3 col-sm-6' itemProp='associatedMedia' itemScope=''>
                            <a href='#javascript' itemProp='contentUrl' data-size='1600x950'>
                              <Media
                                ...
                                alt='Gallery'
                                className='img-thumbnail'
                                onClick={() => setPhotoIndex({ ...photoIndex, index: 3, isOpen: true })}
                              />
                              <div className='caption'>
                                <h4>{PortfolioTitle}</h4>
                                <p>{"is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy."}</p>
                          ...
                          <figure className='col-xl-3 col-sm-6' itemProp='associatedMedia' itemScope=''>
                            <a href='#javascript' itemProp='contentUrl' data-size='1600x950'>
                              <Media
                                ...
                                alt='Gallery'
                                className='img-thumbnail'
                                onClick={() => setPhotoIndex({ ...photoIndex, index: 4, isOpen: true })}
                              />
                              <div className='caption'>
                                <h4>{PortfolioTitle}</h4>
                                <p>{"is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy."}</p>
                          ...
                          <figure className='col-xl-3 col-sm-6' itemProp='associatedMedia' itemScope=''>
                            <a href='#javascript' itemProp='contentUrl' data-size='1600x950'>
                              <Media
                                ...
                                alt='Gallery'
                                className='img-thumbnail'
                                onClick={() => setPhotoIndex({ ...photoIndex, index: 5, isOpen: true })}
                              />
                              <div className='caption'>
                                <h4>{PortfolioTitle}</h4>
                                <p>{"is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy."}</p>
                          ...
                          <figure className='col-xl-3 col-sm-6' itemProp='associatedMedia' itemScope=''>
                            <a href='#javascript' itemProp='contentUrl' data-size='1600x950'>
                              <Media
                                ...
                                alt='Gallery'
                                className='img-thumbnail'
                                onClick={() => setPhotoIndex({ ...photoIndex, index: 6, isOpen: true })}
                              />
                              <div className='caption'>
                                <h4>{PortfolioTitle}</h4>
                                <p>{"is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy."}</p>
                          ...
                          <figure className='col-xl-3 col-sm-6' itemProp='associatedMedia' itemScope=''>
                            <a href='#javascript' itemProp='contentUrl' data-size='1600x950'>
                              <Media
                                ...
                                alt='Gallery'
                                className='img-thumbnail'
                                onClick={() => setPhotoIndex({ ...photoIndex, index: 7, isOpen: true })}
                              />
                              <div className='caption'>
                                <h4>{PortfolioTitle}</h4>
                                <p>{"is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy."}</p>
