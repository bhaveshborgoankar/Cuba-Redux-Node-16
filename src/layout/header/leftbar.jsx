        ...
        <ul className='horizontal-menu'>
                    ...
                    <div className='link-section icon'>
                      ...
                      <ul className={`${megaboxtoggle1 ? 'd-none' : ''}`}>
                        {errorPages.map((pagesItem, i) => (
                          <li key={i}>
                            <Link to={pagesItem.path + '/' + layout}>{pagesItem.title}</Link>
                          </li>
                        ))}
                      </ul>
                    </div>
          ...
          <li className='level-menu outside'>
            ...
            <ul className='header-level-menu menu-to-be-close' style={levelMenu ? { display: '' } : { display: 'none' }}>
              <li>
                <Link to={`${process.env.PUBLIC_URL}/app/file-manager/${layout}`}>
                  <GitPullRequest />
              ...
              <li>
                <Link to={`${process.env.PUBLIC_URL}/app/kanban-board/${layout}`}>
                  <Airplay />
                  <span>{KanbanBoard}</span>
                </Link>
              </li>
              <li>
                <Link to={`${process.env.PUBLIC_URL}/app/bookmark/${layout}`}>
                  <Heart />
                  <span>{Bookmark}</span>
                </Link>
              </li>
              <li>
                <Link to={`${process.env.PUBLIC_URL}/app/social-app/${layout}`}>
                  <Zap />
                  <span>{SocialApp}</span>
                </Link>
              </li>
