...
const Rightbar = () => {
  ...
  const RedirectToChats = () => {
    history(`${process.env.PUBLIC_URL}/app/users/profile/${layout}`);
  };
        ...
        <ul className='nav-menus'>
          ...
          <li className='onhover-dropdown'>
            ...
            <div className={`notification-dropdown onhover-show-div ${notificationDropDown ? 'active' : ''}`}>
              ...
              <ul>
                ...
                <li>
                  <Link className='font-primary f-w-700' to={`${process.env.PUBLIC_URL}/app/ecommerce/orderhistory/${layout}`}>
                    {CheckAllNotification}
                  </Link>
                </li>
              </ul>
          ...
          <li className='cart-nav onhover-dropdown'>
            ...
            <ul className={`cart-dropdown onhover-show-div ${cartDropdown ? 'active' : ''}`}>
              ...
              <li>
                <div className='media'>
                  <img className='img-fluid rounded-circle me-3 img-60' src={require('../../assets/images/ecommerce/01.jpg')} alt='' />
              ...
              <li>
                <div className='media'>
                  <img className='img-fluid rounded-circle me-3 img-60' src={require('../../assets/images/ecommerce/03.jpg')} alt='' />
                  <div className='media-body'>
                    <Link to={`${process.env.PUBLIC_URL}/app/ecommerce/product/${layout}`}>
                      <span>{"V-Neck Collar Woman's T-Shirt"}</span>
                    </Link>
              ...
              <li className='text-center'>
                <Link className='d-block mb-3 view-cart f-w-700' to={`${process.env.PUBLIC_URL}/app/ecommerce/product/${layout}`}>
                  {GoToyourcart}
                </Link>
                <Link className='btn btn-primary view-checkout' to={`${process.env.PUBLIC_URL}/app/ecommerce/checkout/${layout}`}>
                  {CheckOut}
                </Link>
              </li>
            </ul>
          ...
          <li className='onhover-dropdown' onClick={() => setChatDropDown(!chatDropDown)}>
            ...
            <ul className={`chat-dropdown onhover-show-div ${chatDropDown ? 'active' : ''}`}>
              ...
              <li className='text-center'>
                {' '}
                <a href='#javascript' className='font-primary' onClick={RedirectToChat}>
                  {ViewAll}
                </a>
              </li>
            </ul>
          ...
          <li className='profile-nav onhover-dropdown p-0'>
            ...
            <ul className='profile-dropdown onhover-show-div'>
              <li onClick={() => UserMenuRedirect(`${process.env.PUBLIC_URL}/app/users/profile/${layout}`)}>
                <User />
                <span>{Account} </span>
              </li>
              <li onClick={() => UserMenuRedirect(`${process.env.PUBLIC_URL}/app/email-app/${layout}`)}>
                <Mail />
                <span>{Inbox}</span>
              </li>
              <li onClick={() => UserMenuRedirect(`${process.env.PUBLIC_URL}/app/todo-app/to-do/${layout}`)}>
                <FileText />
                <span>{Taskboard}</span>
              </li>
              <li onClick={authenticated ? Logout_From_Auth0 : Logout_From_Firebase}>
                <LogIn />
                <span>{LogOut}</span>
              </li>
            </ul>
