...
const LoginwithValidation = (props) => {
  ...
  return (
    <Container fluid={true} className='p-0'>
      <Row>
        <Col xxl='7' xl='6' className='order-1 b-center bg-size' style={{ backgroundImage: `url(${require('../../assets/images/login/1.jpg')})`, backgroundSize: 'cover', backgroundPosition: 'center', display: 'block' }}>
          <img className='bg-img-cover bg-center' src={require('../../assets/images/login/1.jpg')} alt='looginpage' style={{ display: 'none' }} />
        </Col>
        <Col xxl='5' xl='6' className='p-0'>
                  ...
                  <TabPane className='fade show' tabId={selected === 'firebase' ? 'firebase' : 'jwt'}>
                    <Form className='theme-form'>
                      ...
                      <FormGroup className='mb-0 position-relative'>
                        ...
                        {selected === 'firebase' ? (
                          <Button className="w-100" color='primary' onClick={() => SubmitForm(user.email, user.password)}>
                            {SignIn}
                          </Button>
                        ) : (
                          <Button className="w-100" color='primary'>{LoginWithJWT}</Button>
                        )}
                      </FormGroup>
