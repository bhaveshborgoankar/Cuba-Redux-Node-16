...
const RegisterWithBgImage = (props) => {
  ...
  return (
    <Container fluid={true} className='p-0'>
      <Row>
        <Col xl='5 b-center bg-size' style={{ backgroundImage: `url(${require('../../assets/images/login/3.jpg')})`, backgroundSize: 'cover', backgroundPosition: 'center', display: 'block' }}>
          <img className='bg-img-cover bg-center' src={require('../../assets/images/login/3.jpg')} alt='looginpage' style={{ display: 'none' }} />
        </Col>
