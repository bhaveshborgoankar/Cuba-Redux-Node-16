import { ADD_TO_CART, DECREMENT_QTY, REMOVE_FROM_CART } from '../../actionTypes';
...
const ecommerceReducer = (state = INIT_STATE, action) => {
  switch (action.type) {
    case ADD_TO_CART:
      ...
      console.log('state.cart.findIndex((product) => product.id === productId) !== -1', state.cart.findIndex((product) => product.id === productId) !== -1);
