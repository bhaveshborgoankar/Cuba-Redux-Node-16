...
export const routes = [
  ...
  { path: `${process.env.PUBLIC_URL}/bonus-ui/tour/:layout`, Component: <Tour /> },
  { path: `${process.env.PUBLIC_URL}/bonus-ui/sticky/:layout`, Component: <Sticky /> },
  ...
  { path: `${process.env.PUBLIC_URL}/bonus-ui/dragdrop/:layout`, Component: <DragAndDrop /> },
  { path: `${process.env.PUBLIC_URL}/bonus-ui/image-upload/:layout`, Component: <UploadImage /> },

  { path: `${process.env.PUBLIC_URL}/bonus-ui/card/basic/:layout`, Component: <BasicCards /> },
  { path: `${process.env.PUBLIC_URL}/bonus-ui/card/creative/:layout`, Component: <ThemeCards /> },
  { path: `${process.env.PUBLIC_URL}/bonus-ui/card/tabbed/:layout`, Component: <TabCard /> },
  ...
  { path: `${process.env.PUBLIC_URL}/icons/flag_icons/:layout`, Component: <FlagIcons /> },
  { path: `${process.env.PUBLIC_URL}/icons/fontawesome_icon/:layout`, Component: <FontAwsomeIcon /> },
  { path: `${process.env.PUBLIC_URL}/icons/ico_icon/:layout`, Component: <IcoIcons /> },
  { path: `${process.env.PUBLIC_URL}/icons/themify_icons/:layout`, Component: <FeatherIcons /> },
  { path: `${process.env.PUBLIC_URL}/icons/feather_icons/:layout`, Component: <ThemifyIcons /> },
  { path: `${process.env.PUBLIC_URL}/icons/weather_icons/:layout`, Component: <WeatherIcons /> },
  ...
  { path: `${process.env.PUBLIC_URL}/forms/controls/group/:layout`, Component: <InputGroup /> },
  ...
  { path: `${process.env.PUBLIC_URL}/forms/layout/formwizard/:layout`, Component: <FormWizard1 /> },
  ...
  { path: `${process.env.PUBLIC_URL}/forms/widget/typeahead/:layout`, Component: <Typeahead /> },

  { path: `${process.env.PUBLIC_URL}/table/reactstraptable/basictable/:layout`, Component: <BasicTabels /> },
  { path: `${process.env.PUBLIC_URL}/table/reactstraptable/sizing/:layout`, Component: <BorderTable /> },
  { path: `${process.env.PUBLIC_URL}/table/reactstraptable/border/:layout`, Component: <SizingTable /> },
  ...
  { path: `${process.env.PUBLIC_URL}/charts/knob/:layout`, Component: <KnobChart /> },
  ...
  { path: `${process.env.PUBLIC_URL}/app/gallery/masonrys/:layout`, Component: <MesonryGallery /> },
  ...
  { path: `${process.env.PUBLIC_URL}/app/jobsearch/joblist/:layout`, Component: <JobList /> },
  { path: `${process.env.PUBLIC_URL}/app/jobsearch/jobdetail/:layout`, Component: <JobDetail /> },
  { path: `${process.env.PUBLIC_URL}/app/jobsearch/jobapply/:layout`, Component: <JobApply /> },

  { path: `${process.env.PUBLIC_URL}/app/learning/learninglist/:layout`, Component: <Learninglist /> },
  { path: `${process.env.PUBLIC_URL}/app/learning/learningdetail/:layout`, Component: <LearningDeatil /> },

  { path: `${process.env.PUBLIC_URL}/app/users/profile/:layout`, Component: <UserProfile /> },
  { path: `${process.env.PUBLIC_URL}/app/users/edit/:layout`, Component: <UserEdit /> },
  { path: `${process.env.PUBLIC_URL}/app/users/cards/:layout`, Component: <UserCards /> },
  ...
  { path: `${process.env.PUBLIC_URL}/app/todo-app/to-do/:layout`, Component: <Todo /> },
  { path: `${process.env.PUBLIC_URL}/app/todo-app/firebase/:layout`, Component: <TodoFirebase /> },
];
